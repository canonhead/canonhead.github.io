let user_OS = navigator.userAgent.toLowerCase();
    if(user_OS.indexOf("iphone") != -1 || user_OS.indexOf("ipad") != -1){
        ...
        document.body.innerHTML = "<h1> Redirecting you to the Google Play Store.</h1>";
        window.location.href = "https://play.google.com/store/apps/details?id=com.ouno.terminalvas";
    }
    else{
